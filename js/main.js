...
const app = new Vue({
    ...
    data: {
        ...
        cartItems: [],
        filtered: [],
        imgCart: 'https://picsum.photos/100/50?random',
        products: [],
        imgProduct: 'https://picsum.photos/150/100?random',
        error: false,
        dataError: false
    },
    methods: {
...
class Item{
    constructor(el, img = 'https://picsum.photos/150/100?random'){
...
class Cart extends List{
    constructor(container = ".cart-window", url = "/getBasket.json"){
        super(url, container);
        this.getJson()
            .then(data => {
